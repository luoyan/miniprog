...
public class CalculateBiddingEffect {
	...
	public static class CalculateBiddingEffectMapper extends Mapper<Object, BytesWritable, BytesWritable, BytesWritable> {
        ...
        public void map(Object key, BytesWritable value, Context context) throws IOException, InterruptedException {
    		...
    		MiuiAdStoreServiceLogBiddingEffectRecord thriftObject = (MiuiAdStoreServiceLogBiddingEffectRecord)parseBiddingEffectRecord(miuiLogScribeInfo, items);
    		long downloadNo = thriftObject.getDownloadNo();
    ...
    public static class CalculateBiddingEffectReducer extends Reducer<BytesWritable, BytesWritable, BytesWritable, BytesWritable> {
        @Override
